...
<template>
  <UForm :state="fields" :validate="validate" class="flex flex-col gap-4" @submit="submitForm">
    <div class="flex flex-wrap gap-4 *:min-w-0 *:basis-full md:*:basis-[calc(50%-0.5rem)]">
    ...
    <div class="flex items-center gap-4 max-md:flex-col max-md:items-start">
      <UButton type="submit" color="primary" size="xl" class="min-h-12 rounded-md px-6 font-bold max-md:w-full max-md:justify-center">
        Wyślij wiadomość
      </UButton>
